...
if __name__ == '__main__':
    ...
    config={
        ...
        "dataset_type": "full",
        "dataset": "D:\\dataset\\sheet metal dataset",  # Path containing 'fag', 'labels', 'MFInstseg_partition', and 'steps'
        "transformer_heads" : 4,
    ...
    model_param = torch.load("E:/TGNet/Code/output/2025_03_11_17_52_06/weight_27-epoch.pth", map_location=device)
